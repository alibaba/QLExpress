...
public class GetFieldInstruction extends QLInstruction {
    ...
    private DataField getDataField(Method getMethod, Method setMethod, Field field, Object bean, boolean enableAllowAccessPrivateMethod){
        ...
        if(getMethod != null){
            if(getMethod.isAccessible() || (BasicUtil.isStatic(getMethod) && BasicUtil.isPublic(getMethod))){
        ...
        if(setMethod != null){
            if(setMethod.isAccessible() || (BasicUtil.isStatic(setMethod) && BasicUtil.isPublic(setMethod))){
        ...
        if(field != null){
            if(field.isAccessible() || (BasicUtil.isStatic(field) && BasicUtil.isPublic(field))){
                if(supplier == null){
