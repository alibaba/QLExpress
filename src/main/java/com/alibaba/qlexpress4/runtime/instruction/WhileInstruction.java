...
public class WhileInstruction extends QLInstruction {
    ...
    public QResult execute(QContext qContext, QLOptions qlOptions) {
        ...
        whileBody: while (evalCondition(conditionLambda)) {
            try {
                ...
                throw ThrowUtils
                    .wrapThrowable(t, errorReporter, "WHILE_BODY_EXECUTE_ERROR", "while body execute error");
            }
        }
    ...
    private boolean evalCondition(QLambda conditionLambda) {
        try {
            ...
            throw ThrowUtils.wrapThrowable(t,
                errorReporter,
                QLErrorCodes.WHILE_CONDITION_ERROR.name(),
