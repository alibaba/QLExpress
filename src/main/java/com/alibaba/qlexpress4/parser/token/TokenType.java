...
public enum TokenType {
    ...
    public boolean isKeyword() {
        return hasFixedText && Character.isJavaIdentifierStart(text.charAt(0)) &&
    ...
    public boolean isOperator() {
        switch (this) {
            ...
            case INC: case DEC:
            case BIT_AND: case BIT_OR: case BIT_XOR: case TILDE:
            case LEFTSHIFT: case RIGHSHIFT: case URSHIFT:
            case BANG:
            case GT: case LT: case GE: case LE: case NOEQ:
            case EQ: case ADD_ASSIGN: case SUB_ASSIGN: case MUL_ASSIGN:
            case DIV_ASSIGN: case MOD_ASSIGN: case AND_ASSIGN:
            case OR_ASSIGN: case XOR_ASSIGN: case LSHIFT_ASSIGN:
            case RSHIFT_ASSIGN: case URSHIFT_ASSIGN:
            case DOT: case DOTMUL: case ARROW: case DCOLON:
            case OPTIONAL_CHAINING: case SPREAD_CHAINING:
