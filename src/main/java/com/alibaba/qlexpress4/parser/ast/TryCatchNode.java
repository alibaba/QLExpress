...
public class TryCatchNode extends ASTNode implements StatementNode {
    ...
    public TryCatchNode(int line, int column, String source, BlockNode tryBlock, List<CatchClauseNode> catchClauses, BlockNode finallyBlock) {
    ...
    public List<CatchClauseNode> getCatchClauses() { return catchClauses; }
