...
public class TraceGenerator implements ASTVisitor<TracePointTree, Void> {
    ...
    public TracePointTree visit(VariableDeclarationNode node, Void context) {
        TracePointTree tracePoint = newPoint(TraceType.STATEMENT, Collections.emptyList(),
                node.getTypeName() != null ? node.getTypeName() : "var", node);
        tracePoints.add(tracePoint);
        return null;
    }
    ...
    public TracePointTree visit(AssignmentNode node, Void context) {
        ...
        return newPoint(TraceType.OPERATOR,
                Arrays.asList(targetTrace, valueTrace),
                node.getOperator(),
                node);
    }
    ...
    public TracePointTree visit(TypeDeclarationNode node, Void context) {
        TracePointTree tracePoint = newPoint(TraceType.STATEMENT, Collections.emptyList(),
                node.getTypeName() != null ? node.getTypeName() : "class", node);
        tracePoints.add(tracePoint);
        return null;
    }
    ...
    public TracePointTree visit(LiteralNode node, Void context) {
        return newPoint(TraceType.VALUE, Collections.emptyList(),
                String.valueOf(node.getValue()), node);
    }
    ...
    public TracePointTree visit(BinaryOpNode node, Void context) {
        ...
        return newPoint(TraceType.OPERATOR,
                Arrays.asList(leftTrace, rightTrace),
                node.getOperator(),
                node);
    }
    ...
    public TracePointTree visit(UnaryOpNode node, Void context) {
        ...
        return newPoint(TraceType.OPERATOR,
                Collections.singletonList(operandTrace),
                node.getOperator(),
                node);
    }
    ...
    public TracePointTree visit(ConstructorCallNode node, Void context) {
        return newPoint(TraceType.PRIMARY, Collections.emptyList(),
                node.getTypeName() != null ? node.getTypeName() : "new", node);
    }
    ...
    public TracePointTree visit(TypeNode node, Void context) {
        return newPoint(TraceType.VALUE, Collections.emptyList(),
                node.getTypeName() != null ? node.getTypeName() : "type", node);
    }
