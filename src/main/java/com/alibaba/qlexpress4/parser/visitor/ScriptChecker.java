...
public class ScriptChecker implements ASTVisitor<Void, Void> {
     ...
     */
    public void check(ProgramNode programNode) throws QLSyntaxException {
        try {
    ...
    private void visitNode(Node node, Void context) throws Exception {
    ...
    @Override
    public Void visit(ProgramNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(BlockNode node, Void context) throws Exception {
        for (StatementNode stmt : node.getStatements()) {
            visitNode(stmt, context);
        }
        return null;
    ...
    @Override
    public Void visit(IfNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(WhileNode node, Void context) throws Exception {
        visitNode(node.getCondition(), context);
    ...
    @Override
    public Void visit(ForNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(SwitchNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(TryCatchNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(ReturnNode node, Void context) throws Exception {
        visitNode(node.getValue(), context);
        return null;
    }

    @Override
    public Void visit(BreakNode node, Void context) throws Exception {
        return null;
    }

    @Override
    public Void visit(ContinueNode node, Void context) throws Exception {
        return null;
    }

    @Override
    public Void visit(ThrowNode node, Void context) throws Exception {
        visitNode(node.getException(), context);
        return null;
    }

    @Override
    public Void visit(VariableDeclarationNode node, Void context) throws Exception {
        visitNode(node.getInitialValue(), context);
        return null;
    }

    @Override
    public Void visit(TypeDeclarationNode node, Void context) throws Exception {
        return null;
    }

    @Override
    public Void visit(ImportNode node, Void context) throws Exception {
        return null;
    }

    @Override
    public Void visit(FunctionDefinitionNode node, Void context) throws Exception {
        visitNode(node.getBody(), context);
        return null;
    }

    @Override
    public Void visit(MacroDefinitionNode node, Void context) throws Exception {
        visitNode(node.getBody(), context);
        return null;
    }
    ...
    @Override
    public Void visit(LiteralNode node, Void context) throws Exception {
        return null;
    }

    @Override
    public Void visit(IdentifierNode node, Void context) throws Exception {
        return null;
    }

    @Override
    public Void visit(BinaryOpNode node, Void context) throws Exception {
        // Check binary operator
        checkOperator(node.getOperator(),
                node.getLine(),
                node.getColumn(),
                0);
    ...
    @Override
    public Void visit(UnaryOpNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(TernaryNode node, Void context) throws Exception {
        visitNode(node.getCondition(), context);
    ...
    @Override
    public Void visit(LambdaNode node, Void context) throws Exception {
        visitNode(node.getBody(), context);
        return null;
    }

    @Override
    public Void visit(MethodCallNode node, Void context) throws Exception {
        // Check function call
    ...
    @Override
    public Void visit(ConstructorCallNode node, Void context) throws Exception {
        for (ExpressionNode arg : node.getArguments()) {
            visitNode(arg, context);
        }
        return null;
    ...
    @Override
    public Void visit(AssignmentNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(CastNode node, Void context) throws Exception {
        visitNode(node.getExpression(), context);
        return null;
    }

    @Override
    public Void visit(ArrayAccessNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(ArrayLiteralNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(ListLiteralNode node, Void context) throws Exception {
        for (ExpressionNode element : node.getElements()) {
            visitNode(element, context);
        }
        return null;
    ...
    @Override
    public Void visit(MapLiteralNode node, Void context) throws Exception {
    ...
    @Override
    public Void visit(InstanceOfNode node, Void context) throws Exception {
        visitNode(node.getExpression(), context);
        return null;
    }

    @Override
    public Void visit(TypeNode node, Void context) throws Exception {
        return null;
    }
}
