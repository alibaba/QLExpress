    ...
    public static boolean objectEquals(Object op1, Object op2) {
        ...
        if (op1 instanceof Character || op2 instanceof Character) {
            if (op1 instanceof Character && op2 instanceof Character) {
                ...
                return OperatorOfNumber.compareNumber((Number) op1, (int) (Character) op2) == 0;
            } else if (op2 instanceof Number) {
                return OperatorOfNumber.compareNumber((int) (Character) op1, (Number) op2) == 0;
            } else if (op1 instanceof String) {
                return op2.toString().equals(op1);
            } else if (op2 instanceof String) {
                return op1.toString().equals(op2);
            }
        }
        //数值的值比较
        if (op1 instanceof Number && op2 instanceof Number) {
            //数字比较
            return OperatorOfNumber.compareNumber((Number) op1, (Number) op2) == 0;
        }
        //调用原始Object的比较
        return op1.equals(op2);
    }
