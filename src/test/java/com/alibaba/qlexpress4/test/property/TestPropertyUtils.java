...
//        Assert.assertTrue(PropertiesUtils.getPropertyType(aa,"length").equals(int.class));
        ...
        List<Method> methodValue = CacheUtils.getMethodWithCache(parent, "getMethod1", null, true);
        List<Class<?>> paramType = Arrays.asList(methodValue.get(0).getParameterTypes());
        System.out.println(paramType);

        Function<Integer,String> a = Child::getStaticGetParam;
