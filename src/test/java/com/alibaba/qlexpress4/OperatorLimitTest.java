...
public class OperatorLimitTest {
    ...
    @Test
    public void testAllowAllStrategy() throws QLSyntaxException {
    ...
    public void testWhitelistWithPrefixOperator() {
        Set<Operator> allowedOps = new HashSet<>(Arrays.asList(PlusOperator.getInstance(), PlusPlusPrefixUnaryOperator.getInstance()));
        CheckOptions checkOptions = CheckOptions.builder().whitelist(allowedOps).build();
        Express4Runner runner = new Express4Runner(InitOptions.DEFAULT_OPTIONS);
    ...
    public void testWhitelistWithSuffixOperator() {
        Set<Operator> allowedOps = new HashSet<>(Arrays.asList(PlusOperator.getInstance(), PlusPlusSuffixUnaryOperator.getInstance()));
        CheckOptions checkOptions = CheckOptions.builder().whitelist(allowedOps).build();
        Express4Runner runner = new Express4Runner(InitOptions.DEFAULT_OPTIONS);
    ...
    @Test
    public void testComplexExpressionWithWhitelist() throws QLSyntaxException {
