...
public class SyntaxTreeFactoryTest {
    ...
    public void selectorTest() {
        List<QLInstruction> instructions =
            getScriptInstructions("${ TextField-AXXE } + ${v231}", InterpolationMode.SCRIPT);
        ...
        List<QLInstruction> instructions1 =
            getScriptInstructions("${ TextField-A} + ${v2}", InterpolationMode.VARIABLE);
    ...
    @Test
    public void ifTest() {
        List<QLInstruction> instructions = getScriptInstructions(
            "if (a > 0 && a < 5) {\n" + "  true\n" + "} else if (a > 5 && a < 10) {\n" + "  false\n"
                + "} else if (a > 10 && a < 15) {\n" + "  true\n" + "} == true",
    ...
    private List<QLInstruction> getScriptInstructions(String script, InterpolationMode interpolationMode) {
        QLParser.ProgramContext programContext = SyntaxTreeFactory
            .buildTree(script, new MockOpM(), true, System.out::println, interpolationMode, "${", "}", true);
