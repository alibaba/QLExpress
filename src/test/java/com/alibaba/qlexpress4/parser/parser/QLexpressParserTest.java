...
public class QLexpressParserTest {
     ...
     */
    private ExpressionNode parsePrimary(String source)
        throws QLexpressParser.ParseException {
    ...
    @Test
    public void testParseNegativeDecimalInteger()
        throws Exception {
    ...
    @Test
    public void testParseBinaryInteger()
        throws Exception {
    ...
    @Test
    public void testParseOctalInteger()
        throws Exception {
    ...
    @Test
    public void testParseLongInteger()
        throws Exception {
    ...
    @Test
    public void testParseIntegerWithUnderscores()
        throws Exception {
    ...
    @Test
    public void testParseFloatWithFSuffix()
        throws Exception {
    ...
    @Test
    public void testParseFloatWithDSuffix()
        throws Exception {
    ...
    @Test
    public void testParseFloatWithUnderscores()
        throws Exception {
        ExpressionNode expr = parsePrimary("1_000.123_456");
        Assert.assertTrue("Should be LiteralNode", expr instanceof LiteralNode);
        LiteralNode literal = (LiteralNode)expr;
        Assert.assertEquals("Value should be 1000.123456",
            1000.123456,
            ((Number)literal.getValue()).doubleValue(),
            0.000001);
    }
    ...
    @Test
    public void testParseSingleQuoteString()
        throws Exception {
    ...
    @Test
    public void testParseStringWithBackslashEscape()
        throws Exception {
        ExpressionNode expr = parsePrimary("'hello\\\\world'");
        Assert.assertTrue("Should be LiteralNode", expr instanceof LiteralNode);
        LiteralNode literal = (LiteralNode)expr;
    ...
    @Test
    public void testParseStringWithQuoteEscape()
        throws Exception {
    ...
    @Test
    public void testParseIdentifierWithUnderscore()
        throws Exception {
    ...
    @Test
    public void testParseIdentifierWithDollarSign()
        throws Exception {
        ExpressionNode expr = parsePrimary("$foo");
        Assert.assertTrue("Should be IdentifierNode", expr instanceof IdentifierNode);
        IdentifierNode identifier = (IdentifierNode)expr;
    ...
    @Test
    public void testParseParenthesizedInteger()
        throws Exception {
        ExpressionNode expr = parsePrimary("(42)");
        Assert.assertTrue("Should be LiteralNode", expr instanceof LiteralNode);
        LiteralNode literal = (LiteralNode)expr;
    ...
    @Test
    public void testParseParenthesizedString()
        throws Exception {
        ExpressionNode expr = parsePrimary("('hello')");
        Assert.assertTrue("Should be LiteralNode", expr instanceof LiteralNode);
        LiteralNode literal = (LiteralNode)expr;
    ...
    @Test
    public void testParseParenthesizedIdentifier()
        throws Exception {
        ExpressionNode expr = parsePrimary("(foo)");
        Assert.assertTrue("Should be IdentifierNode", expr instanceof IdentifierNode);
        IdentifierNode identifier = (IdentifierNode)expr;
    ...
    @Test
    public void testParseParenthesizedWithNewlines()
        throws Exception {
        ExpressionNode expr = parsePrimary("(\n42\n)");
        Assert.assertTrue("Should be LiteralNode", expr instanceof LiteralNode);
        LiteralNode literal = (LiteralNode)expr;
    ...
    @Test(expected = QLexpressParser.ParseException.class)
    public void testParseUnclosedParenthesis()
        throws Exception {
    ...
    @Test(expected = QLexpressParser.ParseException.class)
    public void testParseUnexpectedOperator()
        throws Exception {
        QLexpressParser parser = createParser("+");
        parser.parsePrimary();
    }
    ...
    @Test
    public void testParseUnaryPlus()
        throws Exception {
        QLexpressParser parser = createParser("+42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be UnaryOpNode", expr instanceof UnaryOpNode);
    ...
    @Test
    public void testParseUnaryTilde()
        throws Exception {
        QLexpressParser parser = createParser("~42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be UnaryOpNode", expr instanceof UnaryOpNode);
    ...
    @Test
    public void testParseUnaryIncrementPrefix()
        throws Exception {
        QLexpressParser parser = createParser("++x");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be UnaryOpNode", expr instanceof UnaryOpNode);
    ...
    @Test
    public void testParseUnaryDecrementPrefix()
        throws Exception {
        QLexpressParser parser = createParser("--x");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be UnaryOpNode", expr instanceof UnaryOpNode);
    ...
    @Test
    public void testParseNestedUnary()
        throws Exception {
        QLexpressParser parser = createParser("-+-42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be UnaryOpNode", expr instanceof UnaryOpNode);
    ...
    @Test
    public void testParseUnaryIncrementSuffix()
        throws Exception {
        QLexpressParser parser = createParser("x++");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be UnaryOpNode", expr instanceof UnaryOpNode);
    ...
    @Test
    public void testParseUnaryDecrementSuffix()
        throws Exception {
        QLexpressParser parser = createParser("x--");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be UnaryOpNode", expr instanceof UnaryOpNode);
    ...
    @Test
    public void testParseBinaryAddition()
        throws Exception {
    ...
    @Test
    public void testParseBinarySubtraction()
        throws Exception {
    ...
    @Test
    public void testParseBinaryMultiplication()
        throws Exception {
    ...
    @Test
    public void testParseBinaryDivision()
        throws Exception {
    ...
    @Test
    public void testParseBinaryModulus()
        throws Exception {
    ...
    @Test
    public void testParseBinaryEqual()
        throws Exception {
    ...
    @Test
    public void testParseBinaryNotEqual()
        throws Exception {
        QLexpressParser parser = createParser("a != b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryLessThan()
        throws Exception {
        QLexpressParser parser = createParser("a < b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryGreaterThan()
        throws Exception {
        QLexpressParser parser = createParser("a > b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryLessEqual()
        throws Exception {
        QLexpressParser parser = createParser("a <= b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryGreaterEqual()
        throws Exception {
        QLexpressParser parser = createParser("a >= b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryBitwiseAnd()
        throws Exception {
        QLexpressParser parser = createParser("a & b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryBitwiseOr()
        throws Exception {
        QLexpressParser parser = createParser("a | b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryBitwiseXor()
        throws Exception {
        QLexpressParser parser = createParser("a ^ b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryLeftShift()
        throws Exception {
        QLexpressParser parser = createParser("a << b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryRightShift()
        throws Exception {
        QLexpressParser parser = createParser("a >> b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryUnsignedRightShift()
        throws Exception {
        QLexpressParser parser = createParser("a >>> b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryAssignment()
        throws Exception {
    ...
    @Test
    public void testParseBinaryAddAssign()
        throws Exception {
        QLexpressParser parser = createParser("x += 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinarySubAssign()
        throws Exception {
        QLexpressParser parser = createParser("x -= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryMulAssign()
        throws Exception {
        QLexpressParser parser = createParser("x *= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryDivAssign()
        throws Exception {
        QLexpressParser parser = createParser("x /= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryModAssign()
        throws Exception {
        QLexpressParser parser = createParser("x %= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryAndAssign()
        throws Exception {
        QLexpressParser parser = createParser("x &= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryOrAssign()
        throws Exception {
        QLexpressParser parser = createParser("x |= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryXorAssign()
        throws Exception {
        QLexpressParser parser = createParser("x ^= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryLeftShiftAssign()
        throws Exception {
        QLexpressParser parser = createParser("x <<= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryRightShiftAssign()
        throws Exception {
        QLexpressParser parser = createParser("x >>= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseBinaryUnsignedRightShiftAssign()
        throws Exception {
        QLexpressParser parser = createParser("x >>>= 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseMultiplicationBeforeAddition()
        throws Exception {
    ...
    @Test
    public void testParseDivisionBeforeSubtraction()
        throws Exception {
    ...
    @Test
    public void testParseExponentiationChain()
        throws Exception {
    ...
    @Test
    public void testParseComparisonBeforeLogical()
        throws Exception {
    ...
    @Test
    public void testParseBitwiseBeforeComparison()
        throws Exception {
    ...
    @Test
    public void testParseAssignmentLowestPrecedence()
        throws Exception {
    ...
    @Test
    public void testParseUnaryBeforeMultiplication()
        throws Exception {
        QLexpressParser parser = createParser("-a * b");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be BinaryOpNode", expr instanceof BinaryOpNode);
    ...
    @Test
    public void testParseComplexExpression1()
        throws Exception {
    ...
    @Test
    public void testParseComplexExpression2()
        throws Exception {
    ...
    @Test
    public void testParseExpressionWithNewlines()
        throws Exception {
    ...
    @Test
    public void testParseSimpleTernary()
        throws Exception {
        QLexpressParser parser = createParser("a ? b : c");
        ExpressionNode expr = parser.parseExpression();
    ...
    @Test
    public void testParseTernaryWithBinaryCondition()
        throws Exception {
    ...
    @Test
    public void testParseNestedTernary()
        throws Exception {
        QLexpressParser parser = createParser("a ? b : c ? d : e");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be TernaryNode", expr instanceof com.alibaba.qlexpress4.parser.ast.TernaryNode);
        ...
        Assert.assertTrue("Else expr should be TernaryNode (nested)",
            ternary.getElseExpr() instanceof com.alibaba.qlexpress4.parser.ast.TernaryNode);
    }
    
    @Test
    public void testParseTernaryWithMethodCall()
        throws Exception {
        QLexpressParser parser = createParser("a ? foo() : bar()");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be TernaryNode", expr instanceof com.alibaba.qlexpress4.parser.ast.TernaryNode);
        com.alibaba.qlexpress4.parser.ast.TernaryNode ternary = (com.alibaba.qlexpress4.parser.ast.TernaryNode)expr;
        Assert.assertTrue("Then expr should be MethodCallNode",
            ternary.getThenExpr() instanceof com.alibaba.qlexpress4.parser.ast.MethodCallNode);
        Assert.assertTrue("Else expr should be MethodCallNode",
            ternary.getElseExpr() instanceof com.alibaba.qlexpress4.parser.ast.MethodCallNode);
    }
    
    @Test
    public void testParseTernaryWithNewlines()
        throws Exception {
    ...
    @Test
    public void testParseSimpleLambda()
        throws Exception {
    ...
    @Test
    public void testParseLambdaWithBlock()
        throws Exception {
        QLexpressParser parser = createParser("x -> { x + 1 }");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be LambdaNode", expr instanceof com.alibaba.qlexpress4.parser.ast.LambdaNode);
    ...
    @Test
    public void testParseMultiParamLambda()
        throws Exception {
        ...
        Assert
            .assertEquals("First parameter name should be 'x'", "x", lambda.getParameters().get(0).getParameterName());
        Assert
            .assertEquals("Second parameter name should be 'y'", "y", lambda.getParameters().get(1).getParameterName());
    }
    
    @Test
    public void testParseEmptyParamLambda()
        throws Exception {
        QLexpressParser parser = createParser("() -> 42");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be LambdaNode", expr instanceof com.alibaba.qlexpress4.parser.ast.LambdaNode);
    ...
    @Test
    public void testParseTypedParamLambda()
        throws Exception {
    ...
    @Test
    public void testParseSimpleMethodCall()
        throws Exception {
        ...
        com.alibaba.qlexpress4.parser.ast.MethodCallNode methodCall =
            (com.alibaba.qlexpress4.parser.ast.MethodCallNode)expr;
    ...
    @Test
    public void testParseMethodCallWithArgs()
        throws Exception {
    ...
    @Test
    public void testParseChainedMethodCall()
        throws Exception {
        QLexpressParser parser = createParser("a.foo().bar()");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be MethodCallNode", expr instanceof com.alibaba.qlexpress4.parser.ast.MethodCallNode);
    ...
    @Test
    public void testParseMethodCallOnTarget()
        throws Exception {
    ...
    @Test
    public void testParseNestedMethodCalls()
        throws Exception {
        ...
        Assert.assertTrue("First arg should be MethodCallNode",
            methodCall.getArguments().get(0) instanceof com.alibaba.qlexpress4.parser.ast.MethodCallNode);
    }
    
    @Test
    public void testParseMethodCallWithExpressionArgs()
        throws Exception {
        ...
        Assert.assertTrue("Second arg should be BinaryOpNode",
            methodCall.getArguments().get(1) instanceof BinaryOpNode);
    }
    
    @Test
    public void testParseMethodCallWithNewlines()
        throws Exception {
        QLexpressParser parser = createParser("foo\n(\na\n,\nb\n)");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be MethodCallNode", expr instanceof com.alibaba.qlexpress4.parser.ast.MethodCallNode);
    ...
    @Test
    public void testParseSimpleArrayAccess()
        throws Exception {
        QLexpressParser parser = createParser("arr[0]");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be ArrayAccessNode",
            expr instanceof com.alibaba.qlexpress4.parser.ast.ArrayAccessNode);
        com.alibaba.qlexpress4.parser.ast.ArrayAccessNode arrayAccess =
            (com.alibaba.qlexpress4.parser.ast.ArrayAccessNode)expr;
    ...
    @Test
    public void testParseNestedArrayAccess()
        throws Exception {
        ...
        com.alibaba.qlexpress4.parser.ast.ArrayAccessNode arrayAccess =
            (com.alibaba.qlexpress4.parser.ast.ArrayAccessNode)expr;
        Assert.assertTrue("Array should be another ArrayAccessNode",
            arrayAccess.getArray() instanceof com.alibaba.qlexpress4.parser.ast.ArrayAccessNode);
    }
    
    @Test
    public void testParseArrayAccessWithExpression()
        throws Exception {
    ...
    @Test
    public void testParseSimpleConstructorCall()
        throws Exception {
        QLexpressParser parser = createParser("new Foo()");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be ConstructorCallNode",
            expr instanceof com.alibaba.qlexpress4.parser.ast.ConstructorCallNode);
        com.alibaba.qlexpress4.parser.ast.ConstructorCallNode constructorCall =
            (com.alibaba.qlexpress4.parser.ast.ConstructorCallNode)expr;
    ...
    @Test
    public void testParseConstructorCallWithArgs()
        throws Exception {
    ...
    @Test
    public void testParseQualifiedConstructorCall()
        throws Exception {
    ...
    @Test
    public void testParseSimpleCast()
        throws Exception {
    ...
    @Test
    public void testParseQualifiedCast()
        throws Exception {
    ...
    @Test
    public void testParseCastWithBinaryExpression()
        throws Exception {
    ...
    @Test
    public void testParseTernaryWithDifferentMethodCalls()
        throws Exception {
    ...
    @Test
    public void testParseMethodCallChainingWithArrayAccess()
        throws Exception {
    ...
    @Test
    public void testParseLambdaWithMethodCallBody()
        throws Exception {
    ...
    @Test
    public void testParseConstructorCallInMethodArg()
        throws Exception {
        ...
        Assert.assertTrue("Argument should be ConstructorCallNode",
            methodCall.getArguments().get(0) instanceof com.alibaba.qlexpress4.parser.ast.ConstructorCallNode);
    }
    
    @Test
    public void testParseCastInTernary()
        throws Exception {
        QLexpressParser parser = createParser("a ? (int) b : (String) c");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be TernaryNode", expr instanceof com.alibaba.qlexpress4.parser.ast.TernaryNode);
        com.alibaba.qlexpress4.parser.ast.TernaryNode ternary = (com.alibaba.qlexpress4.parser.ast.TernaryNode)expr;
        Assert.assertTrue("Then expr should be CastNode",
            ternary.getThenExpr() instanceof com.alibaba.qlexpress4.parser.ast.CastNode);
        Assert.assertTrue("Else expr should be CastNode",
            ternary.getElseExpr() instanceof com.alibaba.qlexpress4.parser.ast.CastNode);
    }
    
    @Test
    public void testParseArrayAccessInTernary()
        throws Exception {
        QLexpressParser parser = createParser("a ? b[0] : c[1]");
        ExpressionNode expr = parser.parseExpression();
        Assert.assertTrue("Should be TernaryNode", expr instanceof com.alibaba.qlexpress4.parser.ast.TernaryNode);
        com.alibaba.qlexpress4.parser.ast.TernaryNode ternary = (com.alibaba.qlexpress4.parser.ast.TernaryNode)expr;
        Assert.assertTrue("Then expr should be ArrayAccessNode",
            ternary.getThenExpr() instanceof com.alibaba.qlexpress4.parser.ast.ArrayAccessNode);
        Assert.assertTrue("Else expr should be ArrayAccessNode",
            ternary.getElseExpr() instanceof com.alibaba.qlexpress4.parser.ast.ArrayAccessNode);
    }
    ...
    @Test
    public void testParseSimpleIfStatement()
        throws Exception {
        ...
        Assert.assertTrue("Then body should be BlockNode",
            ifNode.getThenBody() instanceof com.alibaba.qlexpress4.parser.ast.BlockNode);
    }
    ...
    @Test
    public void testParseIfThenElseStatement()
        throws Exception {
    ...
    @Test
    public void testParseNestedIfStatement()
        throws Exception {
    ...
    public void testParseElseIfStatement()
        ...
        com.alibaba.qlexpress4.parser.ast.IfNode ifNode = (com.alibaba.qlexpress4.parser.ast.IfNode)stmt;
        Assert.assertNotNull("Else body should not be null", ifNode.getElseBody());
        Assert.assertTrue("Else body should be IfNode (else if)",
            ifNode.getElseBody() instanceof com.alibaba.qlexpress4.parser.ast.IfNode);
    }
    
    @Test
    public void testParseIfWithExpressionThen()
        throws Exception {
    ...
    public void testParseWhileLoop()
        ...
        Assert.assertTrue("Body should be BlockNode",
            whileNode.getBody() instanceof com.alibaba.qlexpress4.parser.ast.BlockNode);
    }
    
    @Test
    public void testParseWhileWithBinaryCondition()
        throws Exception {
    ...
    @Test
    public void testParseTraditionalForLoop()
        throws Exception {
    ...
    @Test
    public void testParseForLoopWithoutInit()
        throws Exception {
    ...
    @Test
    public void testParseForLoopWithoutCondition()
        throws Exception {
    ...
    @Test
    public void testParseForLoopWithoutUpdate()
        throws Exception {
    ...
    @Test
    public void testParseForEachLoop()
        throws Exception {
        QLexpressParser parser = createParser("for (int x : list) { sum = sum + x; }");
        com.alibaba.qlexpress4.parser.ast.StatementNode stmt = parser.parseStatement();
        Assert.assertTrue("Should be ForNode", stmt instanceof com.alibaba.qlexpress4.parser.ast.ForNode);
        com.alibaba.qlexpress4.parser.ast.ForNode forNode = (com.alibaba.qlexpress4.parser.ast.ForNode)stmt;
        Assert.assertTrue("Init should be VariableDeclarationNode for for-each",
            forNode.getInit() instanceof com.alibaba.qlexpress4.parser.ast.VariableDeclarationNode);
    }
    
    @Test
    public void testParseForEachLoopWithoutType()
        throws Exception {
    ...
    @Test
    public void testParseSimpleSwitch()
        throws Exception {
    ...
    @Test
    public void testParseSwitchWithMultipleCases()
        throws Exception {
        QLexpressParser parser =
            createParser("switch (x) { case 1: a = 1; break; case 2: a = 2; break; default: a = 0; }");
        com.alibaba.qlexpress4.parser.ast.StatementNode stmt = parser.parseStatement();
        Assert.assertTrue("Should be SwitchNode", stmt instanceof com.alibaba.qlexpress4.parser.ast.SwitchNode);
        com.alibaba.qlexpress4.parser.ast.SwitchNode switchNode = (com.alibaba.qlexpress4.parser.ast.SwitchNode)stmt;
    ...
    @Test
    public void testParseSwitchWithArrowSyntax()
        throws Exception {
    ...
    @Test
    public void testParseSwitchOnlyDefault()
        throws Exception {
    ...
    @Test
    public void testParseBlockWithStatements()
        throws Exception {
    ...
    @Test
    public void testParseReturnWithValue()
        throws Exception {
        QLexpressParser parser = createParser("return 42;");
        com.alibaba.qlexpress4.parser.ast.StatementNode stmt = parser.parseStatement();
    ...
    @Test
    public void testParseReturnWithoutValue()
        throws Exception {
    ...
    @Test
    public void testParseContinueStatement()
        throws Exception {
    ...
    @Test
    public void testParseThrowStatement()
        throws Exception {
    ...
    public void testParseVariableDeclaration()
        ...
        QLexpressParser parser = createParser("int x;");
        com.alibaba.qlexpress4.parser.ast.StatementNode stmt = parser.parseStatement();
        Assert.assertTrue("Should be VariableDeclarationNode",
            stmt instanceof com.alibaba.qlexpress4.parser.ast.VariableDeclarationNode);
        com.alibaba.qlexpress4.parser.ast.VariableDeclarationNode varDecl =
            (com.alibaba.qlexpress4.parser.ast.VariableDeclarationNode)stmt;
    ...
    @Test
    public void testParseVariableDeclarationWithInitializer()
        throws Exception {
    ...
    @Test
    public void testParseStringVariableDeclaration()
        throws Exception {
    ...
    @Test
    public void testParseSingleStatementProgram()
        throws Exception {
        QLexpressParser parser = createParser("x = 1;");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
    ...
    @Test
    public void testParseMultipleStatementProgram()
        throws Exception {
    ...
    @Test
    public void testParseProgramWithNewlines()
        throws Exception {
        QLexpressParser parser = createParser("x = 1;\ny = 2;\nz = 3;");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
    ...
    @Test
    public void testParseProgramWithBlocks()
        throws Exception {
        QLexpressParser parser = createParser("{ x = 1; } { y = 2; }");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 2 statements", 2, program.getStatements().size());
        Assert.assertTrue("First statement should be BlockNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.BlockNode);
        Assert.assertTrue("Second statement should be BlockNode",
            program.getStatements().get(1) instanceof com.alibaba.qlexpress4.parser.ast.BlockNode);
    }
    
    @Test
    public void testParseProgramWithIfStatement()
        throws Exception {
        QLexpressParser parser = createParser("if (true) { x = 1; } else { x = 2; }");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 1 statement", 1, program.getStatements().size());
        Assert.assertTrue("Statement should be IfNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.IfNode);
    }
    
    @Test
    public void testParseProgramWithWhileLoop()
        throws Exception {
        QLexpressParser parser = createParser("while (i < 10) { i = i + 1; }");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 1 statement", 1, program.getStatements().size());
        Assert.assertTrue("Statement should be WhileNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.WhileNode);
    }
    
    @Test
    public void testParseProgramWithForLoop()
        throws Exception {
        QLexpressParser parser = createParser("for (int i = 0; i < 10; i = i + 1) { sum = sum + i; }");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 1 statement", 1, program.getStatements().size());
        Assert.assertTrue("Statement should be ForNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.ForNode);
    }
    
    @Test
    public void testParseProgramWithSwitch()
        throws Exception {
        QLexpressParser parser = createParser("switch (x) { case 1: a = 1; break; default: a = 0; }");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 1 statement", 1, program.getStatements().size());
        Assert.assertTrue("Statement should be SwitchNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.SwitchNode);
    }
    
    @Test
    public void testParseProgramWithTryCatch()
        throws Exception {
        QLexpressParser parser = createParser("try { x = 1; } catch (Exception e) { x = 0; }");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 1 statement", 1, program.getStatements().size());
        Assert.assertTrue("Statement should be TryCatchNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.TryCatchNode);
    }
    
    @Test
    public void testParseProgramWithReturn()
        throws Exception {
        QLexpressParser parser = createParser("return 42;");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 1 statement", 1, program.getStatements().size());
        Assert.assertTrue("Statement should be ReturnNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.ReturnNode);
    }
    
    @Test
    public void testParseProgramWithVariableDeclaration()
        throws Exception {
        QLexpressParser parser = createParser("int x = 42;");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
        Assert.assertEquals("Should have 1 statement", 1, program.getStatements().size());
        Assert.assertTrue("Statement should be VariableDeclarationNode",
            program.getStatements().get(0) instanceof com.alibaba.qlexpress4.parser.ast.VariableDeclarationNode);
    }
    
    @Test
    public void testParseProgramWithMixedStatements()
        throws Exception {
        String source = "int x = 0;" + "while (x < 10) {" + "  if (x % 2 == 0) {" + "    println(x);" + "  }"
            + "  x = x + 1;" + "}" + "return x;";
        QLexpressParser parser = createParser(source);
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
    ...
    @Test
    public void testParseProgramWithLeadingNewlines()
        throws Exception {
        QLexpressParser parser = createParser("\n\nx = 1;");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
    ...
    @Test
    public void testParseProgramWithTrailingNewlines()
        throws Exception {
        QLexpressParser parser = createParser("x = 1;\n\n");
        com.alibaba.qlexpress4.parser.ast.ProgramNode program = parser.parseProgram();
        Assert.assertNotNull("Program should not be null", program);
