...
public class SyntaxTreeFactoryTest {
    ...
    @Test
    public void testBuildTree_SimpleExpression() throws ParseException {
    ...
    @Test
    public void testBuildTree_MultipleStatements() throws ParseException {
    ...
    @Test
    public void testBuildTree_IfStatement() throws ParseException {
    ...
    @Test
    public void testBuildTree_WhileLoop() throws ParseException {
    ...
    @Test
    public void testBuildTree_ForLoop() throws ParseException {
    ...
    @Test
    public void testBuildTree_ForEachLoop() throws ParseException {
    ...
    @Test
    public void testBuildTree_LambdaExpression() throws ParseException {
    ...
    @Test
    public void testBuildTree_MethodCall() throws ParseException {
    ...
    @Test
    public void testBuildTree_ConstructorCall() throws ParseException {
    ...
    @Test
    public void testBuildTree_TernaryExpression() throws ParseException {
    ...
    @Test
    public void testBuildTree_ReturnStatement() throws ParseException {
    ...
    @Test
    public void testBuildTree_VariableDeclaration() throws ParseException {
    ...
    @Test
    public void testBuildTree_EmptyProgram() throws ParseException {
    ...
    @Test
    public void testBuildTree_WithPrintTree() throws ParseException {
    ...
    @Test
    public void testBuildTree_WithProfile() throws ParseException {
        List<String> output = new ArrayList<>();
        ProgramNode program = SyntaxTreeFactory.buildTree(
                "1 + 2",
                operatorManager,
    ...
    @Test
    public void testBuildTree_DifferentInterpolationModes() throws ParseException {
    ...
    @Test
    public void testBuildTree_CustomSelectorTokens() throws ParseException {
        ProgramNode program = SyntaxTreeFactory.buildTree(
                "1 + 2",
                operatorManager,
                false,
    ...
    @Test
    public void testBuildTree_StrictNewlines() throws ParseException {
        ProgramNode program = SyntaxTreeFactory.buildTree(
                "1 +\n2",
                operatorManager,
                false,
    ...
    @Test
    public void testBuildTree_ComplexExpression() throws ParseException {
        String script = "a = 0;\n" +
                "if (a > 0) {\n" +
                "  return 1;\n" +
                "} else {\n" +
    ...
    public void testBuildTree_SyntaxError() throws ParseException {
        SyntaxTreeFactory.buildTree("if (true", operatorManager);
    }

    @Test
    public void testBuildTree_DefaultOverload() throws ParseException {
        ProgramNode program = SyntaxTreeFactory.buildTree("1 + 2", operatorManager);
        assertNotNull(program);
        assertEquals(1, program.getStatements().size());
    }
    ...
    @Test
    public void testBuildTree_DebugOverload() throws ParseException {
        List<String> output = new ArrayList<>();
        ProgramNode program = SyntaxTreeFactory.buildTreeWithDebug(
                "1 + 2",
                operatorManager,
                output::add);
    ...
    @Test
    public void testBuildTree_SwitchStatement() throws ParseException {
        ProgramNode program = SyntaxTreeFactory.buildTree(
    ...
    @Test
    public void testBuildTree_TryCatchFinally() throws ParseException {
        ProgramNode program = SyntaxTreeFactory.buildTree(
    ...
    @Test
    public void testBuildTree_ThrowStatement() throws ParseException {
    ...
    @Test
    public void testBuildTree_BreakContinue() throws ParseException {
        ProgramNode program = SyntaxTreeFactory.buildTree(
