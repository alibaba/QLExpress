...
public class VariableDetectorTest {
    ...
    @Test
    public void testDetect_VariableRead()
        throws Exception {
    ...
    @Test
    public void testDetect_VariableWrite()
        throws Exception {
    ...
    @Test
    public void testDetect_VariableDeclaration()
        throws Exception {
    ...
    @Test
    public void testDetect_CompoundAssignment()
        throws Exception {
    ...
    @Test
    public void testDetect_VariableInIfStatement()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory.buildTree("if (x > 0) {\n" + "  y = 1;\n" + "}", operatorManager);
        VariableDetector.Context context = detector.detect(program);
    ...
    @Test
    public void testDetect_VariableInWhileLoop()
        throws Exception {
        ProgramNode program =
            SyntaxTreeFactory.buildTree("while (i < 10) {\n" + "  i = i + 1;\n" + "}", operatorManager);
        VariableDetector.Context context = detector.detect(program);
    ...
    @Test
    public void testDetect_VariableInForLoop()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory
            .buildTree("for (int i = 0; i < 10; i++) {\n" + "  sum = sum + i;\n" + "}", operatorManager);
        VariableDetector.Context context = detector.detect(program);
    ...
    @Test
    public void testDetect_VariableInLambda()
        throws Exception {
    ...
    @Test
    public void testDetect_VariableInTernary()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory.buildTree("flag ? a : b", operatorManager);
        VariableDetector.Context context = detector.detect(program);
        
        assertEquals(3, context.getVariableReads().size());
        assertTrue("Should have flag",
            context.getVariableReads().stream().anyMatch(r -> "flag".equals(r.getVariableName())));
    ...
    @Test
    public void testDetect_VariableInTryCatch()
        throws Exception {
    ...
    @Test
    public void testDetect_AllVariableNames()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory.buildTree("a = b + c;\n" + "int d = 10;", operatorManager);
        VariableDetector.Context context = detector.detect(program);
    ...
    @Test
    public void testDetect_ArrayAccess()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory.buildTree("arr[index]", operatorManager);
        VariableDetector.Context context = detector.detect(program);
        
        assertEquals(2, context.getVariableReads().size());
        assertTrue("Should have arr",
            context.getVariableReads().stream().anyMatch(r -> "arr".equals(r.getVariableName())));
        assertTrue("Should have index",
            context.getVariableReads().stream().anyMatch(r -> "index".equals(r.getVariableName())));
    }
    
    @Test
    public void testDetect_MethodCallWithVariable()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory.buildTree("obj.method(arg)", operatorManager);
        VariableDetector.Context context = detector.detect(program);
        
        assertEquals(2, context.getVariableReads().size());
        assertTrue("Should have obj",
            context.getVariableReads().stream().anyMatch(r -> "obj".equals(r.getVariableName())));
        assertTrue("Should have arg",
            context.getVariableReads().stream().anyMatch(r -> "arg".equals(r.getVariableName())));
    }
    
    @Test
    public void testDetect_EmptyProgram()
        throws Exception {
    ...
    @Test
    public void testDetect_LiteralOnly()
        throws Exception {
    ...
    @Test
    public void testDetect_VariableAccessLineNumber()
        throws Exception {
    ...
    @Test
    public void testDetect_VariableToString()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory.buildTree("x = 42", operatorManager);
        VariableDetector.Context context = detector.detect(program);
    ...
    @Test
    public void testDetect_MultipleVariableDeclarations()
        throws Exception {
        ProgramNode program =
            SyntaxTreeFactory.buildTree("int a = 1;\n" + "String b = 123;\n" + "boolean c = true;", operatorManager);
        VariableDetector.Context context = detector.detect(program);
        
        assertEquals(3, context.getVariableDeclarations().size());
        assertTrue("Should have a",
            context.getVariableDeclarations().stream().anyMatch(d -> "a".equals(d.getVariableName())));
        assertTrue("Should have b",
            context.getVariableDeclarations().stream().anyMatch(d -> "b".equals(d.getVariableName())));
        assertTrue("Should have c",
            context.getVariableDeclarations().stream().anyMatch(d -> "c".equals(d.getVariableName())));
    }
    
    @Test
    public void testDetect_SimpleForLoopDeclaration()
        throws Exception {
    ...
    @Test
    public void testDetect_ForEachLoop()
        throws Exception {
