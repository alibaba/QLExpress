...
public class FunctionExtractorTest {
    ...
    @Test
    public void testExtract_DirectFunctionCall()
        throws Exception {
    ...
    @Test
    public void testExtract_MethodCall()
        throws Exception {
    ...
    @Test
    public void testExtract_StaticCall()
        throws Exception {
    ...
    @Test
    public void testExtract_ConstructorCall()
        throws Exception {
    ...
    @Test
    public void testExtract_MultipleFunctionCalls()
        throws Exception {
        ProgramNode program =
            SyntaxTreeFactory.buildTree("a = f1();\n" + "b = f2(1);\n" + "c = f3(1, 2, 3);", operatorManager);
        List<FunctionExtractor.FunctionCall> calls = extractor.extract(program);
    ...
    @Test
    public void testExtract_NestedFunctionCalls()
        throws Exception {
    ...
    @Test
    public void testExtract_FunctionCallInIfStatement()
        throws Exception {
        ProgramNode program =
            SyntaxTreeFactory.buildTree("if (checkCondition()) {\n" + "  doSomething();\n" + "}", operatorManager);
        List<FunctionExtractor.FunctionCall> calls = extractor.extract(program);
    ...
    @Test
    public void testExtract_FunctionCallInWhileLoop()
        throws Exception {
        ProgramNode program =
            SyntaxTreeFactory.buildTree("while (hasMore()) {\n" + "  process(next());\n" + "}", operatorManager);
        List<FunctionExtractor.FunctionCall> calls = extractor.extract(program);
    ...
    @Test
    public void testExtract_FunctionCallInForLoop()
        throws Exception {
        ProgramNode program = SyntaxTreeFactory
            .buildTree("for (int i = 0; i < getCount(); i++) {\n" + "  processItem(i);\n" + "}", operatorManager);
        List<FunctionExtractor.FunctionCall> calls = extractor.extract(program);
    ...
    @Test
    public void testExtract_FunctionCallInLambda()
        throws Exception {
    ...
    @Test
    public void testExtract_FunctionCallInTernary()
        throws Exception {
        ProgramNode program =
            SyntaxTreeFactory.buildTree("isValid() ? getValue() : getDefaultValue()", operatorManager);
        List<FunctionExtractor.FunctionCall> calls = extractor.extract(program);
    ...
    @Test
    public void testExtract_FunctionCallInTryCatch()
        throws Exception {
    ...
    @Test
    public void testExtract_NoFunctionCalls()
        throws Exception {
    ...
    @Test
    public void testExtract_EmptyProgram()
        throws Exception {
    ...
    @Test
    public void testExtract_FunctionCallWithZeroArgs()
        throws Exception {
    ...
    @Test
    public void testExtract_FunctionCallWithManyArgs()
        throws Exception {
    ...
    @Test
    public void testExtract_FunctionCallLineNumber()
        throws Exception {
    ...
    @Test
    public void testExtract_ChainedMethodCalls()
        throws Exception {
        ...
        assertTrue("Should have method1 or method2",
            calls.stream().anyMatch(c -> "method1".equals(c.getName()) || "method2".equals(c.getName())));
    }
    
    @Test
    public void testExtract_ConstructorWithArgs()
        throws Exception {
    ...
    @Test
    public void testExtract_FunctionCallToString()
        throws Exception {
