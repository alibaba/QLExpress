...
public class QLExpress4PerformanceTest {
    ...
    public void test_long_collection() throws Exception {
        String expression
            = "sellerId not_in [3438,8287,10620,10663,11175,11740,15670,16724,17692,18198,19362,21054,23139,23743,24561,29708,29848,32330,32833,"
            + "33366,35044,41363,41387,44712,46066,47147,48580,50706,52144,52150,52402,54712,59575,62492,72218,74553,74901,79447,79459,81348,83046,"
            + "86399,87885,89547,90600,90609,93714,94507,97043,99115]";
        DefaultContext<String, Object> context = new DefaultContext<>();
        context.put("sellerId", 2025L);
        execute(expression, context, 100L);
    }
