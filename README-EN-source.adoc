...
> For `version`, we recommend using the latest stable release, `4.1.2`.
...
3. Run unit tests: After completing code development, run all unit tests locally with `mvn test` to ensure code quality.
